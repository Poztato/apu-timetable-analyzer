          ...
          <aside className="tn-live-panel" aria-label="Live setup summary">
            <div className="tn-concept-card">
              ...
              <div>
                <strong>APU Timetable Analyzer</strong>
                <p>
                  Everyone says that their timetable is bad, but how bad is it really?
                  <br /><br />
                  This website extracts every single timetable in APU, ranks them, then tells you
                  how bad your timetable actually is.
                </p>
              </div>
            </div>
            ...
            <section className="tn-social-card" aria-labelledby="tn-social-title">
              <div className="tn-social-heading">
                <strong style={{ fontSize: 20 }} id="tn-social-title">Social Links</strong>
              </div>
              <ul className="tn-social-links" aria-label="Leonard Su's links">
                <li>
                  <a
                    href="https://leonardsu.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Website, leonardsu.com (opens in a new tab)"
                  >
                    <span className="tn-social-icon is-website" aria-hidden="true">
                      <img
                        src={`${import.meta.env.BASE_URL}potato-logo.png`}
                        alt=""
                      />
                    </span>
                    <span className="tn-social-copy">
                      <strong>Personal Website</strong>
                      <small>leonardsu.com</small>
                    </span>
                    <svg className="tn-social-arrow" viewBox="0 0 16 16" aria-hidden="true">
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/leonard-su/"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="LinkedIn, Leonard Su (opens in a new tab)"
                  >
                    <span className="tn-social-icon is-linkedin" aria-hidden="true">
                ...
                <li>
                  <a
                    href="https://github.com/Poztato/"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="GitHub, @Poztato (opens in a new tab)"
                  >
                    <span className="tn-social-icon is-github" aria-hidden="true">
                ...
                <li>
                  <a
                    href="mailto:leonardsu.contact@gmail.com"
                    aria-label="Email Leonard Su at leonardsu.contact@gmail.com"
                  >
                    <span className="tn-social-icon is-gmail" aria-hidden="true">
                      <svg viewBox="0 0 24 24">
                    ...
                    <span className="tn-social-copy">
                      <strong>Email</strong>
                      <small>leonardsu.contact@gmail.com</small>
                    </span>
                  </a>
                </li>
              </ul>
